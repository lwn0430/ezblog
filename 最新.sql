...
alter table bg_user add user_image varchar(50) not null default 'default.jpg';

--插入两条记录
insert into module values (1,'PHP技术'),
                          (2,'网络技术');
--publish 表中添加一列module_id
alter table publish add mudule_id int unsigned not null default 1;